...
def read_info_header_version(bmpFile):
    ...
    if dynamicList[0] != "42" or dynamicList[1] != "4d":
...
#Function used to select the file that the user wants to analyze and return its path
#The function even controls if the paths exist, caughting the exception FileNotFoundError
def selectFile():
