...
I added the tkinter function askopenfilenames() which allows you to select the file directly via a GUI, removing the need to write the path manually and lowering
